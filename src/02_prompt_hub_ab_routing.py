...
# Tên phải DUY NHẤT trong Hub của bạn. Đổi tiền tố nếu muốn cá nhân hoá.
PROMPT_V1_NAME = "nguyenduckhang-rag-prompt-v1"
PROMPT_V2_NAME = "nguyenduckhang-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
# V1 — phong cách NGẮN GỌN: trả lời súc tích 2-4 câu, đi thẳng trọng tâm.
SYSTEM_V1 = (
...
# V2 — phong cách CÓ CẤU TRÚC: giọng chuyên gia, phân tích facts, 3-5 câu mạch lạc.
SYSTEM_V2 = (
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            ...
            description="V1 – phong cách ngắn gọn, súc tích (2-4 câu)",
        )
    ...
    try:
        url = client.push_prompt(
            ...
            description="V2 – phong cách có cấu trúc, giọng chuyên gia (3-5 câu)",
        )
