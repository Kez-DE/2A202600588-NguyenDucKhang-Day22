...
# ChatPromptTemplate gồm 2 messages: system (chứa {context}) + human ({question})
...
# Decorator @traceable phía TRÊN chữ ký hàm → LangSmith tự ghi input/output/latency
...
def main():
    ...
    # Tạo vectorstore từ knowledge base
    vectorstore = setup_vectorstore()

    # Xây dựng RAG chain và retriever
